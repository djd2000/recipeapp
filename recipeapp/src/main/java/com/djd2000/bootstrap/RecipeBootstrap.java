...
public class RecipeBootstrap implements CommandLineRunner {
	...
	private void loadData() {
		...
		guacNotes.setRecipeNotes("The BEST guacamole! EASY to make with ripe avocados, salt, serrano chiles, cilantro and lime. Garnish with red radishes or jicama. Serve with tortilla chips.");
		...
		spicyGrilledChickenTacosCategories.add(categoryMexican.get());
		...
		tacoNotes.setRecipeNotes("Spicy grilled chicken tacos! Quick marinade, then grill. Ready in about 30 minutes. Great for a quick weeknight dinner, backyard cookouts, and tailgate parties.");
